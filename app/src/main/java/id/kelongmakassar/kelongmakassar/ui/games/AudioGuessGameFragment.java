 ...
 * {@link AudioGuessGameFragment.OnFragmentInteractionListener} interface
...
public class AudioGuessGameFragment extends Fragment {
     ...
     */
    public static AudioGuessGameFragment newInstance(String param1) {
        AudioGuessGameFragment fragment = new AudioGuessGameFragment();
        Bundle args = new Bundle();
        args.putString(ARG_TEXT_QUESTION, param1);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            mTextQuestion = getArguments().getString(ARG_TEXT_QUESTION);
        }
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        initLayoutWithQuestion(mTextQuestion);

        return rootView;
    }

    private void initLayoutWithQuestion(String param1) {
